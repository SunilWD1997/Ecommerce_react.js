  ...
  return (
    <div className="categories">
      ...
      <div className="col">
        ...
        <button><Link className='link' to='/products/3'>Children</Link> </button>
        </div>
        <div className="row">
        <img src="https://images.pexels.com/photos/2036646/pexels-photo-2036646.jpeg?auto=compress&cs=tinysrgb&w=1600" alt="" />
        <button><Link className='link' onClick={()=>alert('sorry there is no stuck')}>Women</Link> </button>
      ...
      <div className="col col_long">
        ...
        <button><Link className='link' onClick={()=>alert('sorry there is no stuck of accessories')}>Accessories</Link> </button>
            </div>
          </div>
        </div>
        <div className="row">
        <img src="https://images.pexels.com/photos/1159670/pexels-photo-1159670.jpeg?auto=compress&cs=tinysrgb&w=1600" alt="" />
        <button><Link className='link' onClick={()=>alert('sorry there is no stuck of shoes')}>Shoes</Link> </button>
        </div>
      </div>
